    ...
    Private Sub PropriétéToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PropriétéToolStripMenuItem.Click, Proprietes_ToolStripButton.Click
        If Not SOLUTION Is Nothing AndAlso Me.TreeViewMultiSelect1.SelectedNodes.Count > 0 Then
            ...
            If Form1.Box_Proprietes.Controls.Count > 0 Then
                ...
                boxProp.PropertyGrids1.SelectedObjects = Nothing
                boxProp.PropertyGrids1.Item.Clear()
                boxProp.PropertyGrids1.ItemSet.Clear()
                boxProp.PropertyGrids1.ShowCustomProperties = True
                boxProp.PropertyGrids1.Refresh()
                ...
                If Me.TreeViewMultiSelect1.SelectedNodes.Count = 1 Then
                    If Me.TreeViewMultiSelect1.SelectedNodes(0).ImageIndex = 15 OrElse Me.TreeViewMultiSelect1.SelectedNodes(0).ImageIndex = 18 OrElse Me.TreeViewMultiSelect1.SelectedNodes(0).ImageIndex = 19 Then
                        boxProp.KryptonRichTextBox1.Rtf = "{\rtf1" & Me.TreeViewMultiSelect1.SelectedNodes(0).Text & "}}"
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_3"), Me.TreeViewMultiSelect1.SelectedNodes(0).Text, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_2"), True)
                        boxProp.PropertyGrids1.Refresh()
                    ElseIf Me.TreeViewMultiSelect1.SelectedNodes(0).ImageIndex = 0 Then
                        boxProp.KryptonRichTextBox1.Rtf = "{\rtf1" & SOLUTION.Nom & " {\b(" & RM.GetString("Dock_Explorateur_Solution_Proprietes_12") & ")}}"
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_3"), SOLUTION.Nom, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_6"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_4"), SOLUTION.Emplacement & "\" & SOLUTION.Nom_Fichier_Projet, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_7"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_8"), SOLUTION.ProjetDemarrage, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_5"), RM.GetString("Dock_Explorateur_Solution_Proprietes_9"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_10"), SOLUTION.Projets.Count, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_5"), RM.GetString("Dock_Explorateur_Solution_Proprietes_11"), True)
                        boxProp.PropertyGrids1.Refresh()
                    ElseIf (Me.TreeViewMultiSelect1.SelectedNodes(0).ImageIndex = 1 OrElse Me.TreeViewMultiSelect1.SelectedNodes(0).ImageIndex = 2 OrElse Me.TreeViewMultiSelect1.SelectedNodes(0).ImageIndex = 17) AndAlso Not SOLUTION.GetProject(Me.TreeViewMultiSelect1.SelectedNodes(0).Tag) Is Nothing Then
                        boxProp.KryptonRichTextBox1.Rtf = "{\rtf1" & Me.TreeViewMultiSelect1.SelectedNodes(0).Tag & " {\b(" & RM.GetString("Dock_Explorateur_Solution_Proprietes_13") & ")}}"
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_3"), Me.TreeViewMultiSelect1.SelectedNodes(0).Tag, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_14"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_4"), SOLUTION.GetProject(Me.TreeViewMultiSelect1.SelectedNodes(0).Tag).Emplacement & "\" & SOLUTION.GetProject(Me.TreeViewMultiSelect1.SelectedNodes(0).Tag).Nom_Fichier_Projet, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_15"), True)
                        If SOLUTION.GetProject(Me.TreeViewMultiSelect1.SelectedNodes(0).Tag).Loaded Then
                            If SOLUTION.GetProject(Me.TreeViewMultiSelect1.SelectedNodes(0).Tag).Type = VelerSoftware.SZVB.Projet.Projet.Types.ApplicationWindows Then
                                boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_16"), RM.GetString("Dock_Explorateur_Solution_Proprietes_17"), True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_16"), True)
                            ElseIf SOLUTION.GetProject(Me.TreeViewMultiSelect1.SelectedNodes(0).Tag).Type = VelerSoftware.SZVB.Projet.Projet.Types.ApplicationConsole Then
                                boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_16"), RM.GetString("Dock_Explorateur_Solution_Proprietes_18"), True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_16"), True)
                            Else
                                boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_16"), RM.GetString("Dock_Explorateur_Solution_Proprietes_19"), True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_16"), True)
                            End If
                            boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_20"), SOLUTION.GetProject(Me.TreeViewMultiSelect1.SelectedNodes(0).Tag).GenerateDirectory, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_5"), RM.GetString("Dock_Explorateur_Solution_Proprietes_21"), True)
                        End If
                        boxProp.PropertyGrids1.Refresh()
                    ElseIf My.Computer.FileSystem.FileExists(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText) AndAlso Not SOLUTION.GetProject(Me.TreeViewMultiSelect1.SelectedNodes(0).Tag) Is Nothing Then
                        boxProp.KryptonRichTextBox1.Rtf = "{\rtf1" & My.Computer.FileSystem.GetName(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText) & " {\b(" & RM.GetString("Dock_Explorateur_Solution_Proprietes_22") & ")}}"
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_4"), Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_23"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_3"), My.Computer.FileSystem.GetName(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText), True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_24"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_25"), My.Computer.Registry.GetValue("HKEY_CLASSES_ROOT\" & My.Computer.Registry.GetValue("HKEY_CLASSES_ROOT\" & My.Computer.FileSystem.GetFileInfo(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).Extension, "", "ExtensionNotFound"), "", RM.GetString("Dock_Explorateur_Solution_Proprietes_26") & " " & My.Computer.FileSystem.GetFileInfo(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).Extension.Trim(".")), True, RM.GetString("Dock_Explorateur_Solution_Proprietes_27"), RM.GetString("Dock_Explorateur_Solution_Proprietes_28"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_29"), System.IO.File.GetCreationTime(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).ToShortDateString & " - " & System.IO.File.GetCreationTime(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).ToShortTimeString, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_27"), RM.GetString("Dock_Explorateur_Solution_Proprietes_32"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_30"), System.IO.File.GetLastWriteTime(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).ToShortDateString & " - " & System.IO.File.GetLastWriteTime(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).ToShortTimeString, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_27"), RM.GetString("Dock_Explorateur_Solution_Proprietes_33"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_31"), System.IO.File.GetLastAccessTime(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).ToShortDateString & " - " & System.IO.File.GetLastAccessTime(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).ToShortTimeString, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_27"), RM.GetString("Dock_Explorateur_Solution_Proprietes_34"), True)
                        If FileLen(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText) > 1024 Then
                            boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_38"), Microsoft.VisualBasic.FormatNumber(FileLen(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText) / 1024, 0, TriState.True, TriState.True, TriState.True) & " Ko", True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_39"), True)
                        Else
                            boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_38"), Format(FileLen(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText), "##0 Octets"), True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_39"), True)
                        End If
                        boxProp.PropertyGrids1.Refresh()
                    ElseIf My.Computer.FileSystem.DirectoryExists(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText) AndAlso Not SOLUTION.GetProject(Me.TreeViewMultiSelect1.SelectedNodes(0).Tag) Is Nothing Then
                        boxProp.KryptonRichTextBox1.Rtf = "{\rtf1" & My.Computer.FileSystem.GetName(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText) & " {\b(" & RM.GetString("Dock_Explorateur_Solution_Proprietes_40") & ")}}"
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_4"), Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_41"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_3"), My.Computer.FileSystem.GetName(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText), True, RM.GetString("Dock_Explorateur_Solution_Proprietes_1"), RM.GetString("Dock_Explorateur_Solution_Proprietes_42"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_29"), System.IO.Directory.GetCreationTime(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).ToShortDateString & " - " & System.IO.Directory.GetCreationTime(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).ToShortTimeString, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_27"), RM.GetString("Dock_Explorateur_Solution_Proprietes_35"), True)
                        boxProp.PropertyGrids1.Item.Add(RM.GetString("Dock_Explorateur_Solution_Proprietes_30"), System.IO.Directory.GetLastWriteTime(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).ToShortDateString & " - " & System.IO.Directory.GetLastWriteTime(Me.TreeViewMultiSelect1.SelectedNodes(0).ToolTipText).ToShortTimeString, True, RM.GetString("Dock_Explorateur_Solution_Proprietes_27"), RM.GetString("Dock_Explorateur_Solution_Proprietes_36"), True)
