...
#Region "SZ Initialisation"
    ...
    Private Sub SZ_Initialisation_BackgroundWorker_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles SZ_Initialisation_BackgroundWorker.DoWork
        ...
        With My.Computer.FileSystem
            ...
            ' DISABLED: Updater auto-start disabled to prevent background updates
    ...
    Private Sub SZ_Initialisation_BackgroundWorker_RunWorkerCompleted(ByVal sender As System.Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles SZ_Initialisation_BackgroundWorker.RunWorkerCompleted
        ...
        ' Wrap in try-catch to handle TypeLoadException for missing WCF components (System.ServiceModel.MessageQuerySet)
        Try
        ...
        Catch ex As System.TypeLoadException
            ' Ignore TypeLoadException - WCF components not available on this system
            ' This doesn't affect the core functionality of the application
            Log_SZ.Log.Add(New ClassLog.LogType(ClassLog.LogType.Tip.Warning, "DesignerMetadata registration skipped due to missing WCF components: " & ex.Message))
        Catch ex As Exception
            ' Log any other exceptions but don't crash
            Log_SZ.Log.Add(New ClassLog.LogType(ClassLog.LogType.Tip.Warning, "DesignerMetadata registration failed: " & ex.Message))
        End Try
...
#Region "SZ Activation"
    ...
    Private Sub SZ_Activation_BackgroundWorker_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles SZ_Activation_BackgroundWorker.DoWork
        ' LICENSE REMOVED: Always treat as activated Professional edition
        ' Set edition to Professional if not already
        If Not My.Settings.Edition = ClassApplication.Edition.Professional Then
            My.Settings.Edition = ClassApplication.Edition.Professional
        End If
        SZ_Est_Activé = True
        e.Result = 4 ' Success - fully activated
    End Sub
...
#Region "SZ Banned User"
    ...
    Private Sub SZ_Banned_User_BackgroundWorker_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles SZ_Banned_User_BackgroundWorker.DoWork
        ' LICENSE REMOVED: Banned user check disabled - application is now open source
        ' No longer checks online list of banned activation codes
    End Sub
